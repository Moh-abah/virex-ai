...
const teamMembers = [
  {
    ...
    image: 'https://ui-avatars.com/api/?background=00C9A7&color=fff&size=100&name=AA',
    whatsapp: '+966501234567',
    email: 'ahmed.rashid@virex-ai.com',
    description: 'Oversees project delivery and client relations.',
  },
  {
    id: 2,
    name: 'Dr. Sarah Al-Mansour',
    role: 'Technical Manager',
    title: 'AI & Algorithmic Engineering',
    image: 'https://ui-avatars.com/api/?background=302b63&color=fff&size=100&name=SM',
    whatsapp: '+966502345678',
    email: 'sarah.mansour@virex-ai.com',
    description: 'Leads R&D and software architecture.',
  },
  {
    id: 3,
    name: 'Omar Al-Farouk',
    ...
    image: 'https://ui-avatars.com/api/?background=005F60&color=fff&size=100&name=OF',
    whatsapp: '+966503456789',
    email: 'omar.farouk@virex-ai.com',
    description: 'Specializes in embedded systems and IoT.',
  },
]
